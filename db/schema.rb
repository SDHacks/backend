...
ActiveRecord::Schema.define(version: 20141009065118) do
  ...
  add_index "hackers", ["authentication_token"], name: "index_hackers_on_authentication_token", unique: true, using: :btree
